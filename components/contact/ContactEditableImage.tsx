...
interface ContactEditableImageProps {
  src: string;
  alt: string;
  width?: number;
  height?: number;
...
const ContactEditableImage = forwardRef<{ openEditor: () => void }, ContactEditableImageProps>(({
  src,
  alt,
  width,
  height,
  ...
  const { isEditMode: contextEditMode, setIsDirty: contextSetIsDirty } = useContactEdit();
...
ContactEditableImage.displayName = 'ContactEditableImage';

export default ContactEditableImage; 