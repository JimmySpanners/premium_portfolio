...
import type { TextWithVideoRightSection as TextWithVideoRightSectionType } from "@/app/custom_pages/types/sections";
import { MediaLightbox } from "@/app/custom_pages/components/sections/MediaLightbox";

interface Props {
  section: TextWithVideoRightSectionType & { imageSrc?: string; imageAlt?: string };
  isEditMode: boolean;
  onSectionChange: (section: TextWithVideoRightSectionType) => void;
}

export function TextWithVideoRightSection({ section, isEditMode, onSectionChange }: Props) {
  ...
  return (
    ...
    >
      ...
      {/* Video/Image Placeholder - clickable for lightbox */}
