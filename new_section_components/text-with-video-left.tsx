...
interface TextWithVideoLeftProps {
  title: string
  tagline: string
  description: string
  videoId: string
...
export function TextWithVideoLeft({
  title,
  tagline,
  description,
  videoId,
  ...
  isEditMode = false,
  onSectionChange
}: TextWithVideoLeftProps) {
  if (isEditMode && onSectionChange) {
    return (
      <div className="flex flex-col md:flex-row-reverse items-center gap-12 mb-24 last:mb-0">
